...
#define MISC_MEM_MAP_VALUE(offset) (*((volatile unsigned int *)(0x76000000 + offset)))
...
#define MISC_SD_CD_PIN                      ((0x1 << 16))
#define MISC_SD_WP_PIN                      ((0x1 << 17))
...
{ \
    (MISC_GPIOA_PIN_ENABLE_REG) |= (MISC_EXT_INT0_PIN); \
}

#define HAL_MISC_DISABLE_EXT_INT1_PIN() \
{ \
    (MISC_GPIOA_PIN_ENABLE_REG) &= ~(MISC_EXT_INT1_PIN); \
}

#define HAL_MISC_ENABLE_EXT_INT2_PIN() \
{ \
    (MISC_GPIOA_PIN_ENABLE_REG) |= (MISC_EXT_INT2_PIN); \
}
...
{ \
    (MISC_GPIOB_PIN_ENABLE_REG) |= MISC_SPI_PIN; \
}
...
{ \
    (MISC_GPIOA_PIN_ENABLE_REG) |= (MISC_SD_CD_PIN | MISC_SD_WP_PIN | MISC_SD_CLK_PIN |MISC_SD_CMD_PIN |MISC_SD_DT7_PIN|MISC_SD_DT6_PIN | \
