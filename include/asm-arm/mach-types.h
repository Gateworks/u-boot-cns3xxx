...
#ifdef CONFIG_MACH_VEGA
# ifdef machine_arch_type
#  undef machine_arch_type
#  define machine_arch_type     __machine_arch_type
# else
#  define machine_arch_type     MACH_TYPE_VEGA
# endif
# define machine_is_vega()  (machine_arch_type == MACH_TYPE_VEGA)
#else
# define machine_is_vega()  (0)
#endif
